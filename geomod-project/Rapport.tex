...
\begin{itemize}
    \item A button Del All, which cleared the drawin Widget. \\The steps to follow where the same as Del Curve, but there was no pre-existing function that eliminated all curves, and we couldn't make it work. Same for a function that would permit to move an entire curve, or to resize it.
