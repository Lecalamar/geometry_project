...
class Curve2DAitkenChordal : public Curve2DAitken {
 private:
  Vector2f tab[RESOLUTION_A]; //points which will linked
 public:
 Curve2DAitkenChordal(const QString &name) : Curve2DAitken(name) {}
 Curve2DAitkenChordal(Curve2D *curve,const QString &name) : Curve2DAitken(curve,name) {}
